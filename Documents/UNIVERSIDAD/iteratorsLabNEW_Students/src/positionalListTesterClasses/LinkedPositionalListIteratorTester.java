...
public class LinkedPositionalListIteratorTester {
...
//			showList2("After removing even numbers, list1 = ", list1); 
		...
		private static void showRev(String msg, LinkedPositionalList<Integer> list) {
			
			System.out.print(msg);
			Iterator<Integer> iter =list.iteratorRev();
			while(iter.hasNext())
				System.out.print(iter.next()+ " ");
		}
	}
